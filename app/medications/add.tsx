          ...
          <View style={styles.section}>
            ...
            >
              <View style={styles.dateIconContainer}>
                <Ionicons name="calendar" size={20} color="#6EC1E4" />
              </View>
              ...
              <View style={styles.switchRow}>
                <View style={styles.switchLabelContainer}>
                  <View style={styles.iconContainer}>
                    <Ionicons name="notifications" size={20} color="#6EC1E4" />
                  </View>
                  <View>
                ...
                <Switch
                  ...
                  trackColor={{ false: "#ddd", true: "#6EC1E4" }}
                  thumbColor="white"
                />
              </View>
            </View>
          ...
          <View style={styles.section}>
            <View style={styles.card}>
              <View style={styles.switchRow}>
                <View style={styles.switchLabelContainer}>
                  <View style={styles.iconContainer}>
                    <Ionicons name="reload" size={20} color="#6EC1E4" />
                  </View>
                  <View>
